const img = {
  ...
  effectSlipperyPaddle: new Image(),
};

img.foreground.src = "img/foreground.svg";
img.background.src = "img/background.svg";
img.freezingForeground.src = "img/freezing-foreground.svg";
img.arrowUp.src = "img/arrow-up.svg";
img.icicles.src = "img/icicles.svg";
...
img.effectSlipperyPaddle.src = "img/effects/slippery-paddle.svg";
